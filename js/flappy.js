...
function Passaro(alturaJogo) {
    let voando = false
    this.elemento = novoElemento('img', 'uni')
    this.elemento.src = 'imgs/uni.png'
    ...
    this.start = () => {
        const temporizador = setInterval(() => {
            ...
            if(colidiu(passaro, barreiras)) {
                ...
                if (window.confirm(`Fim de jogo!! Você fez ${pontos} pontos!`)) location.reload()
            }
        }, 20)
    }
}

new FlappyUnicorn().start()    